...
- When there are app updates ready to commit, push, or deploy: always show a summary of changes and ask for confirmation before proceeding with commit, push, or deployment.
- Never commit, push to GitHub, or deploy to VPS without explicit user confirmation.
